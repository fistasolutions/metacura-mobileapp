...
import { Screen, ScreenHeader, AppText, Button, GlassCard } from '../../components';
  ...
  return (
    <Screen contentStyle={{ flexGrow: 1 }} edges={['top', 'bottom']}>
      <View style={{ flex: 1 }}>
        ...
        {/* Crystal question cards, vertically centered between header and foot. */}
          ...
          <GlassCard contentStyle={{ gap: t.spacing[4] }}>
            ...
            <Pressable
              ...
              style={({ pressed }) => ({
                ...
                borderWidth: 1.5,
                borderColor: open ? t.colors.accent : t.colors.borderStrong,
        ...
        {/* Focus picker — a bottom sheet whose list scrolls on its own. */}
        <Modal
          visible={open}
          transparent
          animationType="slide"
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <AppText variant="cardTitle">Choose a focus</AppText>
